...
console.log(chalk.blue.bold("\n \t Welcome to Mathias - Todo-List Application\n"));
        ...
        let option = await inquirer.prompt([
            {
                ...
                choices: ["AddTask", "Delet Task", "Update Task", "View Todo-List", "Exit"],
    ...
    let taskIndex = await inquirer.prompt([
        {
            name: "index",
            type: "number",
            message: "Enter the 'Index no.' of the task you want todelete :",
        }
    ]);
